#
# docker build . --build-arg COMPOSER_HASH=dac665fdc30fdd8ec78b38b9800061b4150413ff2e3b6f88543c636f7cd84f6db9189d43a81e5503cda447da73c7e5b6 --tag abenevaut/yaf-cms:test
# docker run -p 8080:8080 -v .:/var/task abenevaut/yaf-cms:local
#
...
ENV nginx_client_max_body_size=2M \
    ...
    php_xdebug_mode=coverage,develop,trace,debug \
